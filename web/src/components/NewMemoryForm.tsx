...
export const NewMemoryForm = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="inline-block self-end rounded-full px-5 py-3 bg-green-500 font-alt text-sm uppercase leading-none text-black transition-colors hover:bg-green-600"
      >
        Salvar
      </button>
    </form>
